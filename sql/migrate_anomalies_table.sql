-- =====================================================
-- Migration table anomalies : ancien schéma → nouveau schéma
-- =====================================================
-- Supprime l'ancienne table anomalies (ancien schéma ML)
-- et la recrée avec le nouveau schéma pour validate_data_quality.py

-- 1. Supprimer l'ancienne table (si vous voulez garder les données, faire un backup avant)
...
-- 3. Index pour recherches fréquentes
CREATE INDEX idx_anomalies_validation_run ON anomalies(validation_run_id);
...
-- 4. Vue pour statistiques quotidiennes
...
INSERT INTO anomalies (
    ...
    'info',
    'migration',
    'Table anomalies migrée vers nouveau schéma v2.3',
    NOW(),
    0
);
...
SELECT 
    ...
    COUNT(DISTINCT validation_run_id) as unique_runs,
